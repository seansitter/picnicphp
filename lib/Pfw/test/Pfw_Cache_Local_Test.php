...
class Pfw_Cache_Local_Test extends Pfw_UnitTest_PHPUnit_FwkTestCase
{
    ...
    public function testSetDelete()
    {
        Pfw_Cache_Local::set('test', 'ok');
        $this->assertEquals('ok', Pfw_Cache_Local::get('test'));
        Pfw_Cache_Local::delete('test');
        $this->assertEquals(null, Pfw_Cache_Local::get('test'));
    }

    public function testOptions()
    {
        Pfw_Config::setConfig(array(
            'local_cache' => array('class' => 'Pfw_Cache_Stub', 'stuff' => 'ok')
        ));
